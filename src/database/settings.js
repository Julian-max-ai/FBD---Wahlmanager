...
async function saveGuildSettings(settings) {
  ...
  const merged = existing
    ...
    : settings;
  if (existing) {
    await run(`UPDATE guild_settings SET wahlkampftyp=?,vorstandRoleId=?,vorstandChannelId=?,campaignChannelId=?,archiveChannelId=?,imageStoreChannelId=?,plakatRequestChannelId=?,plakatReviewChannelId=?,panelMessageId=?,campaignMessageId=?,plakatPanelMessageId=?,activeEntryId=?,pointsPoster=?,pointsSpeech=?,currentCampaignName=? WHERE guildId=?`,
      [merged.wahlkampftyp??null,merged.vorstandRoleId??null,merged.vorstandChannelId??null,merged.campaignChannelId??null,merged.archiveChannelId??null,merged.imageStoreChannelId??null,merged.plakatRequestChannelId??null,merged.plakatReviewChannelId??null,merged.panelMessageId??null,merged.campaignMessageId??null,merged.plakatPanelMessageId??null,merged.activeEntryId??null,merged.pointsPoster??3,merged.pointsSpeech??5,merged.currentCampaignName??null,merged.guildId]);
  } else {
    await run(`INSERT INTO guild_settings (guildId,wahlkampftyp,vorstandRoleId,vorstandChannelId,campaignChannelId,archiveChannelId,imageStoreChannelId,plakatRequestChannelId,plakatReviewChannelId,panelMessageId,campaignMessageId,plakatPanelMessageId,activeEntryId,pointsPoster,pointsSpeech,currentCampaignName) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
      [merged.guildId,merged.wahlkampftyp??null,merged.vorstandRoleId??null,merged.vorstandChannelId??null,merged.campaignChannelId??null,merged.archiveChannelId??null,merged.imageStoreChannelId??null,merged.plakatRequestChannelId??null,merged.plakatReviewChannelId??null,merged.panelMessageId??null,merged.campaignMessageId??null,merged.plakatPanelMessageId??null,merged.activeEntryId??null,merged.pointsPoster??3,merged.pointsSpeech??5,merged.currentCampaignName??null]);
  }
